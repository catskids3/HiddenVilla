...
namespace HiddenVilla.Api.Controllers
{
	...
	public class HotelRoomController : Controller
	{
		...
		public async Task<IActionResult> GetHotelRooms(string checkInDate = null, string checkOutDate = null)
		{
			...
			if (!DateTime.TryParseExact(checkInDate, "MM/dd/yyyy", CultureInfo.InvariantCulture,
			...
			if (!DateTime.TryParseExact(checkOutDate, "MM/dd/yyyy", CultureInfo.InvariantCulture,
